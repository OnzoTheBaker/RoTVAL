...
import mvpbg from "../../assets/BLANK.png";
import mvptexture from "../../assets/BLANK.png";
...
const LiveMVP = () => {
    ...
    const gitImageStyleBitchiz = {
		...
		astra: { backgroundSize: "auto 150%", backgroundPositionY: "30px" },
		skye: { backgroundSize: "auto 150%", backgroundPositionY: "30px" },
		yoru: { backgroundSize: "auto 150%", backgroundPositionY: "30px" },
        sage: {
            backgroundSize: "auto 150%",
            transform: "scaleX(-1)",
    ...
    return (
        <div className={c.root}>
            <div className="container">
                <Typography variant="h1" color="White" className="headline">
                    {mvp.name}
                </Typography>
